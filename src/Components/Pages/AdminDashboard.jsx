    ...
    return (
        ...
        {loggedUser ?
            <div className="page-body dashboard s-mt-4 s-pt-4">
                    ...
                    <div className="utility-panel lg-cols-2 center">
                            <ul className="utility-list">
                                <li className="list-item normal">
                                    <Button variant="link" onClick={()=>handleCourses()}>Cursos</Button> 
                                </li>
                                <li className="list-item normal">
                                    <Button variant="link" onClick={()=>handleUsers()}>Usuarios</Button> 
                                </li>
                            </ul>
                    </div>
                </div>
